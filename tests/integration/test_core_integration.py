...
import bmchat.crypto.keys as _km_orig  # noqa: E402
...
import bmchat.core.client as _cm  # noqa: E402
...
class MockNet:
    ...
    def announce_object(self, o):
        self._ann.append(bytes(o) if o else o)
...
def test_database_lock_rlock_integration():
    ...
    try:
        ...
        # tenta adquirir duas vezes com timeout curto: Lock falhará, RLock
        # sucederá — ambos aceitos, mas não pode deadlock
